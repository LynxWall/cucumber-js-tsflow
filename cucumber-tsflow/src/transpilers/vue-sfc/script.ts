...
export function getResolvedScript(descriptor: SFCDescriptor, ssr: boolean): SFCScriptBlock | null | undefined {
	return (ssr ? ssrCache : clientCache).get(descriptor);
}

export function setResolvedScript(descriptor: SFCDescriptor, script: SFCScriptBlock, ssr: boolean): void {
