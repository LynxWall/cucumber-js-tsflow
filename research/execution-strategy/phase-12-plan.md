...
| P | **closed by measurement (group 6)**: three clean A/B pairs on the UIS suite, the compile cache neutral (off 40 to 70 ms quicker to bootstrap, never slower); kept as shipped, the owner may drop it in 12d (see the hand-off) | 6 | the measurement |
