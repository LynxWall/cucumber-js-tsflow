...
[Phase 12 scope](#phase-12-scope) for the strands, the decisions to take, and the exit criteria.
...
Phase 12 is the release gate. Phases 1–11 each ended green on `yarn test:all`, but that suite was written for the
